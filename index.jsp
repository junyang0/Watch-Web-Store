...
<body>
        ...
        <div class="container">
            <div class="navbar">
                <div class="logo">
                    ...
                    <div class="search" >
                        <form action="products.jsp" method="get" style="display:flex">   
                        <input type="text" placeholder="Search by Ref No." name="referenceNumber">
                        <br>
            ...
            <div class="row">
                <div class="col-2">
                    ...
                    <p style="color:black"> Luxury <br> For All </p>
                    <btn class="btn"> Our Collections </btn>
                </div>
                <div class="col-2">
    ...
    <div class="categories">
        <div class="small-container">
            ...
            <div class="row">
                <div class="col-3" >
                    <img src="images/category-1.png" alt="" style = "width: 70%; height:auto; float:right;">
                </div>
                <div class="col-3">
                    <img src="images/image1.webp" alt="" style=" width:120%; float:left;">
                </div>
                <div class="col-3">
                    <img src="images/category-3.jpg" alt="" style="width:290px;height:auto">
                </div>
            </div>
